    ...
    <PageWrapper>
      <PageHero
        ...
        title={
          <>
            L'excellence,
            <br />
            <span className="italic text-accent">à votre mesure.</span>
          </>
        }
      ...
      <section className="relative h-[46svh] min-h-[340px] overflow-hidden border-y border-border-gold">
        ...
        <div className="relative z-10 mx-auto flex h-full max-w-container items-center px-6 md:px-12">
          <Reveal>
            <p className="max-w-2xl font-display text-3xl font-light italic leading-snug text-text-primary md:text-5xl">
