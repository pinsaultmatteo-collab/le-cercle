/* Minimal custom SVG icons — no icon library. */
...
export function PhoneIcon({ size = 16, className = '' }) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M5 3h4l2 5-3 2a13 13 0 0 0 6 6l2-3 5 2v4a2 2 0 0 1-2 2A17 17 0 0 1 3 7a2 2 0 0 1 2-2z" />
    </svg>
  )
}

/* A clean SVG recreation of the Le Cercle circular mark. */
export function CircleMark({ size = 48, className = '' }) {
  return (
    <svg
      width={size}
      height={size}
